...
public class SQLiteHelper extends SQLiteOpenHelper {
	...
	public Retailer getRetailer() {
		...
		String strQuery = "SELECT splashImage, poweredBy, headerColor, retailerTextColor, retailerName, retailerFileType, retailerFile, companyLogo, backdropColor1, backdropColor2, backdropType, backdropFile FROM RETAILER";
	...
	public void insertOrReplaceRetailer(Retailer retailer) {
		...
		contentValues.put("retailerTextColor", retailer.getRetailerTextColor());
		contentValues.put("retailerName", retailer.getRetailerName());
		contentValues.put("retailerFileType", retailer.getRetailerFileType());
